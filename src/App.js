...
import {TextField, Button, Select, MenuItem, Radio, Checkbox, FormControlLabel} from '@material-ui/core'
  ...
  return (
    ...
    <Formik 
      initialValues={{
        ...
        cookies: [],
        yogurt: '',
        pets: [{type: 'cat', name: 'mill', id: '' + Math.random() }]
        }} 
      ...
      {({values, errors, isSubmitting})=> (
        ...
        />
          ...
          <Field name='cookies' type='checkbox' value='sniker' as={Checkbox} />
          <Field name='cookies' type='checkbox' value='sugar' as={Checkbox} />

          <div>Yogurt:</div>
          <MyRadio name='yogurt' type='radio' value='peach' label='peach'  />
          <MyRadio name='yogurt' type='radio' value='bluebarry' label='bluebarry'  />
